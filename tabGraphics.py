...
class Tab:
    def __init__(self, parentFrame, graphicsDemands=False):
        ...
        if not graphicsDemands:
            ...
            _tkRadiobuttons['Off'] = tk.Radiobutton(
                tkFrame_Controls,
                text='Off',
            ...
            _tkRadiobuttons['FullControl'] = tk.Radiobutton(
                tkFrame_Controls,
                text='Full control',
                variable=self.vars['rFactoryControl'],
                value='Full control')
        ...
        _tkCheckbuttons['ReplayOnly'] = tk.Checkbutton(
            tkFrame_Controls, text='Replay only', variable=self.vars['ReplayOnly'])
        ...
        _tkCheckbuttons['MaybeRain'] = tk.Checkbutton(
            tkFrame_Conditions,
        ...
        _tkCheckbuttons['NightRacing'] = tk.Checkbutton(
            tkFrame_Conditions,
            text='There will be racing in the dark',
            variable=self.vars['NightRacing'])
        Tooltip(
            _tkCheckbuttons['NightRacing'],
            text='No night racing, '
        ...
        ####################################################
        tkFrame_GraphicsSetup = tk.LabelFrame(
            parentFrame, text='Graphics setup')
        tkFrame_GraphicsSetup.grid(
            column=2,
            row=0,
            rowspan=3,
            sticky='new',
        ...
        tkLabel_GraphicsCapability = tk.Label(
            tkFrame_GraphicsSetup,
            text='Overall\ngraphics\ncapability',
            font=fontBoldItalic,
            justify=tk.LEFT)
        tkLabel_GraphicsCapability.grid(
            column=_GraphicsCapabilityCol, row=1, sticky='nw')

        tkScale_GraphicsCapability = tk.Scale(
            tkFrame_GraphicsSetup,
            from_=0,
            to=10,
            orient=tk.VERTICAL,
            variable=self.vars['GraphicsCapability'])
        tkScale_GraphicsCapability.grid(
            column=_GraphicsCapabilityCol, row=2, rowspan=3, sticky='ew')
        Tooltip(tkScale_GraphicsCapability,
                text='How powerful is your graphics card and PC?')

        tkLabel_Graphics_0 = tk.Label(tkFrame_GraphicsSetup, text='Potato')
        tkLabel_Graphics_0.grid(
            column=_GraphicsCapabilityCol, row=2, sticky='nw')
        tkLabel_Graphics_10 = tk.Label(tkFrame_GraphicsSetup, text='Ninja!')
        tkLabel_Graphics_10.grid(
            column=_GraphicsCapabilityCol, row=4, sticky='nw')
        ...
        tkLabel_GraphicsPreference.grid(column=_GraphicsPreferenceCol,
                                        row=1,
                                        sticky='n')
        tkScale_GraphicsPreference = tk.Scale(
            tkFrame_GraphicsSetup,
            from_=0,
            to=10,
            orient=tk.VERTICAL,
        ...
        tkScale_GraphicsPreference.grid(column=_GraphicsPreferenceCol,
                                        row=3,
                                        sticky='ewns')
        Tooltip(tkScale_GraphicsPreference,
                text='Do you prefer performance or eye candy?')

        tkLabel_Graphics_10 = tk.Label(
            tkFrame_GraphicsSetup, text='Frame rate')
        tkLabel_Graphics_10.grid(
            column=_GraphicsPreferenceCol, row=2, sticky='nw')
        tkLabel_Graphics_0 = tk.Label(tkFrame_GraphicsSetup, text='Eye candy')
        tkLabel_Graphics_0.grid(
            column=_GraphicsPreferenceCol, row=4, sticky='nw')

        ####################################################
        if not graphicsDemands:
            return  # This frame is not required, graphics demands are set by rFactory

        tkFrame_GraphicsDemands = tk.LabelFrame(
            parentFrame, text='Graphics demands')
        ...
        tkScale_CarGraphicsDemands = tk.Scale(
            tkFrame_GraphicsDemands,
            from_=-5,
            to=5,
            orient=tk.VERTICAL,
        ...
        tkScale_CarGraphicsDemands.grid(column=_CarGraphicsDemandsCol,
                                        ...
                                        sticky='ew')
        Tooltip(
            tkScale_CarGraphicsDemands,
            text="Is the car you're using well\n"
            "optimised or an FPS killer?")

        tkLabel_Graphics_0 = tk.Label(
            tkFrame_GraphicsDemands, text='Optimised')
        tkLabel_Graphics_0.grid(
            column=_CarGraphicsDemandsCol, row=2, sticky='nw')
        tkLabel_Graphics_10 = tk.Label(tkFrame_GraphicsDemands, text='Heavy')
        tkLabel_Graphics_10.grid(
            column=_CarGraphicsDemandsCol, row=6, sticky='nw')
        ...
        tkScale_TrackGraphicsDemands = tk.Scale(
            tkFrame_GraphicsDemands,
            from_=-5,
            to=5,
            orient=tk.VERTICAL,
        ...
        tkScale_TrackGraphicsDemands.grid(column=_TrackGraphicsDemandsCol,
                                          ...
                                          sticky='ew')
        Tooltip(
            tkScale_TrackGraphicsDemands,
            text="Is the track you're using well\n"
            "optimised or an FPS killer?")

        tkLabel_Graphics_0 = tk.Label(
            tkFrame_GraphicsDemands, text='Optimised')
        tkLabel_Graphics_0.grid(
            column=_TrackGraphicsDemandsCol,
            row=2,
            sticky='nw')
        tkLabel_Graphics_10 = tk.Label(tkFrame_GraphicsDemands, text='Heavy')
        tkLabel_Graphics_10.grid(
            column=_TrackGraphicsDemandsCol, row=6, sticky='nw')
...
def setGraphics(graphicsSetup,
  ...
  """
    ...
    if 'TrackGraphicsDemands' in graphicsSetup:
        trackGraphicDetailsFactor = int(
            graphicsSetup['TrackGraphicsDemands']) * 2
    ...
    if graphicsSetup['rFactoryControl'] == 'Replay only':
        ...
        graphicsLoad *= (1 +
                         int(graphicsSetup['GraphicsPreference']) /
                         EYE_CANDY_FACTOR)
        graphicsLevel = int(graphicsSetup['GraphicsCapability']) \
            * (1 / graphicsLoad)
        if graphicsLevel > MAX_GRAPHICS_LEVEL:
