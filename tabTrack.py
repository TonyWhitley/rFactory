...
class Tab:
    def __init__(self, parentFrame):
        ...
        self.mc.configure_column(
            len(config_tabTrack['trackColumns']) - 1, width=0, minwidth=0)
        # Left justify the data in the first four columns
        self.mc.configure_column(0, anchor='w')
        self.mc.configure_column(1, anchor='w')
        self.mc.configure_column(2, anchor='w')
        self.mc.configure_column(3, anchor='w')
    ...
    class __TrackData:
        ...
        def fetchData(self):
            ...
            self.data = getAllTrackData(
                tags=config_tabTrack['trackColumns'], maxWidth=20)
            return self.data
