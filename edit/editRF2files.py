...
def readCar():
    allTracks = os.path.join(rF2root, r'UserData\player\All Tracks & Cars.cch')
    _strip = 'SinglePlayerVehicle=%s' % os.path.normpath(
        os.path.join(rF2root, r'Installed\Vehicles'))
...
def changeTrack(
    ...
    _edited = __edit(
        _text4, [
            _edit4, _edit5, _edit6, _edit7], doubleSlash=True)
...
def readOpponents():
    allTracks = os.path.join(rF2root, r'UserData\player\All Tracks & Cars.cch')
    _strip = 'SinglePlayerFilter=%s' % os.path.normpath(
        os.path.join(rF2root, r'Installed\Vehicles'))
    _lines, error = readFile(allTracks)
    for line in _lines:
...
if __name__ == '__main__':
    ...
    _edit3 = [
        ...
        os.path.join(
            rF2root,
            r'Installed\Vehicles\Oreca_07_LMP2_2017\1.41\ORECA07PREE6ED8B36.VEH"').replace(
            '\\',
            '\\\\')]
    _edit3 = [
        r'( *SinglePlayerVehicle *=).*',
        ...
        os.path.join(
            rF2root,
            r'Installed\Vehicles\Norma_M30-LMP3_2017\1.51\NORMAM30_08.VEH"').replace(
            '\\',
            '\\\\')]
    ...
    _edit4 = [
        ...
        os.path.join(
            rF2root,
            r'Installed\Locations\F1_1988_Tracks\0.941\HOCKENHEIM_1988_C4.SCN",').replace(
            '\\',
            '\\\\\\\\')]
    ...
    changeCar(
        vehPath=r'Installed\Locations\Oreca_07_LMP2_2017\1.41',
        vehName='ORECA07PREE6ED8B36')
    changeTrack(
        scnPath=r'Installed\Locations\OULTON_PARK_CIRCUIT_2015\1.25',
        scnName='OULTONPARK_INT',
        SceneDescription=r'OULTONPARK_INT')

    changeCar(
        vehPath=r'Installed\Locations\Norma_M30-LMP3_2017\1.51',
        vehName='NORMAM30_08')
    changeTrack(
        scnPath=r'Installed\Locations\F1_1988_Tracks\0.941',
        scnName='HOCKENHEIM_1988_C4',
        SceneDescription=r'HOCKENHEIM_1988_C4')

    vehBits = getSingleCarData(
        'Oreca_07_LMP2_2017', [
