...
BUILD_REVISION = 140  # The git commit count
versionStr = 'rFactory V0.7.%d' % BUILD_REVISION
versionDate = '2029-01-03'
...
class MainWindow:
    ...
    def centreWindow(self):
        ...
        # this is fetching the monitor maxium height
        screen_height = self.handle.winfo_screenheight()
        # This is getting the correct
...
class Tabs:
    ...
    """
        ...
        for name, tab in self.tabNames:
            self.tabs[name] = ttk.Frame(
                self.notebook, height=tabHeight, width=tabWidth)
