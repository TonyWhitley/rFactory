...
def vehicle(path):
    return os.path.join(r"c:\Program Files (x86)\Steam\steamapps\common\rFactor 2\Installed\Vehicles", path)
def location(path):
    return os.path.join(r"c:\Program Files (x86)\Steam\steamapps\common\rFactor 2\Installed\Locations", path)
